...
ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "18.191.95.73 localhost 127.0.0.1").split(" ")
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', '0812'),
        'HOST': os.getenv('SQL_HOST', 'database'),  # 🔹 Usa 'database', no 'localhost'
